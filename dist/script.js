$(document).ready(function dR() {
    ...
    const FACTORIAL = function () {
      ...
      function factorial(value) {
        ...
        if (parseInt(value) != value) {
          // result = loopFactorial(parseInt(value)) * mockGamma(fixFloat(value % 1));
          // return result;
          return NaN;
        }
    ...
    const RUN_ORDER = function () {
      ...
      function checkStack(input, stack, value) {
        ...
        while (stack.length > 0 && OPERATORS[PEEK(stack).operator].priority >= OPERATORS[input].priority) {
          ...
          if (value !== value) {
            //NaN
            //put op back into stack (don't want strange results on next button push!)
            stack.push(thisOp);
            ...
            if (thisOp.operator == "!" && !Number.isInteger(startingVal)) {
              return setRunData(totalString, "", "Not configured for factorial of non-integer");
            }
            if (thisOp.operator == "!" && startingVal < 0) {
              return setRunData(totalString, "", "Cannot get factorial of negative number");
            }
        ...
        if (lastOperator.length > 0) {
          ...
          if (!isParens(lastOp)) {
            ...
            if (lastOp == ")") {
              ...
              stack.push(thisOp);
              //shuffle stacks so that we are reloading the nested stack
              stacks.parent = stack;
          ...
          if (lastOperator.length == 0 || REQ_OP_AFTER.has(penOp)) {
            ...
            if (lastOp != ")") {
              if (thisOp) {
                ...
                if (penOp != ")") {
                  if (totalString.indexOf("0start") > -1) {
          ...
          totalString = totalString.replace(/0start/g, "");
      ...
      function runOrderOps(input) {
        ...
        if (lastOp != ")" && input != ")") {
          if (REQ_OP_AFTER.has(lastOp) && input == lastOp) {
            return setRunData(totalString, "", "Cannot have two in a row");
          }
        }
        if (lastOp == "=") {
  ...
  function unitTests() {
    ...
    ["<sup>2</sup>", "720*3<sup>2</sup>", "(3!)!*&radic;(9)<sup>2</sup>", "Cannot have two in a row"],
    ["backspace", "720*&radic;(9)", "(3!)!*&radic;(9)", ""],
    ["backspace", "720*&radic;(9", "(3!)!*&radic;(9", ""],
    ["backspace", "720*&radic;(9", "(3!)!*&radic;(9", ""],
    ...
    ["backspace", "2,160*&radic;(10,000+0", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0", ""],
    ["2", "2,160*&radic;(10,000+0", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0", "Operator required"],
    ["!", "2,160*&radic;(10,000+0!", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0!", ""],
    [")", "2,160*&radic;(10,001)", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0!)", ""],
    ["backspace", "2,160*&radic;(10,000+0!", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0!", ""],
    ["backspace", "2,160*&radic;(10,000+0", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0", ""],
    ["backspace", "2,160*&radic;(10,000+0", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0", ""],
    ["+", "2,160*&radic;(10,000+", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+", ""],
    ["Ans", "2,160*&radic;(10,000+Ans", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+Ans", ""],
    ["backspace", "2,160*&radic;(10,000+", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+", ""],
    ["backspace", "2,160*&radic;(10,000+", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+", ""],
    ["e", "2,160*&radic;(10,000+e", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e", ""],
    ["backspace", "2,160*&radic;(10,000+", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+", ""],
    ["backspace", "2,160*&radic;(10,000+", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+", ""],
    ["e", "2,160*&radic;(10,000+e", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e", ""],
    ["*", "2,160*&radic;(10,000+2.718281828459045*", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e*", ""],
    ["backspace", "2,160*&radic;(10,000+2.718281828459045", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e", ""],
    ["backspace", "2,160*&radic;(10,000+2.718281828459045", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e", ""],
    ["*", "2,160*&radic;(10,000+2.718281828459045*", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e*", ""],
    ["PI", "2,160*&radic;(10,000+2.718281828459045*&pi;", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e*&pi;", ""],
    ["backspace", "2,160*&radic;(10,000+2.718281828459045*", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e*", ""],
    ["backspace", "2,160*&radic;(10,000+2.718281828459045*", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e*", ""],
    ["-", "2,160*&radic;(10,000+2.718281828459045*", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e*", "Number required to run operation"], //because had PI in number buffer, can't change operator now
    ["2", "2,160*&radic;(10,000+2.718281828459045*2", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e*2", ""],
    ["-", "2,160*&radic;(10,005.436563656918-", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e*2-", ""],
    [")", "2,160*&radic;(10,005.436563656918)", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e*2)", ""],
    ["backspace", "2,160*&radic;(10,000+2.718281828459045*2", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e*2", ""],
    ["backspace", "2,160*&radic;(10,000+2.718281828459045*2", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e*2", ""],
    [")", "2,160*&radic;(10,005.436563656918)", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e*2)", ""],
    ["=", "216,058.70690948263", "(3!)!*&radic;(9*&radic;(1))*&radic;(10^(2+2)+0+e*2)=", ""],
    ["=", "", "", ""],
    ["3", "3", "3", ""],
    ["<sup>2</sup>", "3<sup>2</sup>", "3<sup>2</sup>", ""],
    ["backspace", "3", "3", ""],
    ["+", "3+", "3+", ""],
    ["6", "3+6", "3+6", ""],
    ["<sup>2</sup>", "3+6<sup>2</sup>", "3+6<sup>2</sup>", ""],
    ["(", "3+36*(", "3+6<sup>2</sup>*(", ""],
    ["backspace", "3+36*", "3+6<sup>2</sup>*", ""],
    ["backspace", "3+6<sup>2</sup>", "3+6<sup>2</sup>", ""],
    ["backspace", "3+6", "3+6", ""],
    ["backspace", "3+6", "3+6", ""],
    ["-", "9-", "3+6-", ""],
    ["(", "9-(", "3+6-(", ""],
    ["&radic;(", "9-(&radic;(", "3+6-(&radic;(", ""],
    ["backspace", "9-(", "3+6-(", ""],
    ...
    ["4", "-4", "-4", ""],
    ["!", "-4!", "-4!", ""],
    ["+", "-4!", "-4!", "Cannot get factorial of negative number"],
    ...
    ["9", "3.9", "3.9", ""],
    ["!", "3.9!", "3.9!", ""],
    ["=", "3.9!", "3.9!", "Not configured for factorial of non-integer"],
    ["=", "3.9!", "3.9!", "Not configured for factorial of non-integer"],
    //result from google calc
    // ["3", "3", "3", ""],
    // [".", "3.", "3.", ""],
    // ["9", "3.9", "3.9", ""],
    // ["!", "3.9!", "3.9!", ""],
